...
namespace HarmonyLibTests.Tools
{
	...
	public class Test_AccessCache : TestLogger
	{
		...
		void InjectProperty(AccessCache cache, bool declaredOnly = false)
		{
			...
			ClassicAssert.NotNull(f_properties);
		...
		public void Test_AccessCache_Field()
		{
			...
			ClassicAssert.NotNull((new AccessCache()).GetFieldInfo(type, "field1"));
		...
		public void Test_AccessCache_Property()
		{
			...
			ClassicAssert.NotNull((new AccessCache()).GetPropertyInfo(type, "Property1"));
		...
		public void Test_AccessCache_Method()
		{
			...
			ClassicAssert.NotNull((new AccessCache()).GetMethodInfo(type, "Method1", Type.EmptyTypes));
