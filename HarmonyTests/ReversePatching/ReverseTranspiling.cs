...
namespace HarmonyLibTests.ReversePatching
{
	...
	public class ReverseTranspiling : TestLogger
	{
		...
		public void Test_ReverseTranspilerPatching()
		{
			...
			ClassicAssert.AreEqual("Original123Prolog", result1);
			...
			ClassicAssert.NotNull(standin);
			ClassicAssert.NotNull(standin.method);
			...
			ClassicAssert.AreEqual("EpilogOriginal", result2);
		}
	}
}
